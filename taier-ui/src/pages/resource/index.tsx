...
export default connect(
	resourceManagerTree,
	({ panel, headerToolBar, folderTree }: IResourceViewProps & IFolderTree) => {
		...
		const handleRightClick = (treeNode: ITreeNodeItemProps) => {
			...
			switch (treeNode.fileType) {
				...
				case FileTypes.Folder: {
					...
					return ROOT_FOLDER_ACTIONS.concat([
				...
				.then((res) => {
					if (res.code === 1) {
						...
						if (currentNode?.data.parentId !== params.nodePid) {
							const nextParentNode = resourceManagerTree.get(
			...
			<div className="resourceManager-container">
				...
				<Content>
					<div tabIndex={0} className="resourceManager-content">
						<FolderTree
							onExpandKeys={(keys) => resourceManagerTree.setExpandKeys(keys)}
